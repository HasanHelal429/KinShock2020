...
**tier** Full · **deck** `inputs_kinshock_h2_shape3` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I + Sec. II
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/h2_shape3`.
...
| `inputs_kinshock_h2_shape3` | generated deck (tracked, **never hand-edit**) |
