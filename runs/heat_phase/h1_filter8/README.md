...
**tier** Full · **deck** `inputs_kinshock_h1_filter8` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I + Sec. II
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/h1_filter8`.
...
| `inputs_kinshock_h1_filter8` | generated deck (tracked, **never hand-edit**) |
