...
> Negative control (B0 = 0). Clone of R1_warm with field.orientation = unmagnetized so the applied Bx = 0. Confirms the magnetic compression, ion heating, secondary compression, and reflected-ion signatures vanish without a background field (Fig. 9).

**tier** Core · **deck** `inputs_kinshock_R2` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Fig. 9
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/R2`.
...
| field orientation | unmagnetized | `field.orientation` |
...
| `inputs_kinshock_R2` | generated deck (tracked, **never hand-edit**) |
