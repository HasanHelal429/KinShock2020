...
> Uniform periodic ambient box, dz = 0.15 d_e,ab (dz/lambda_D = 3.033), ppc 50 (N_D = 16.5). Grid-heating resolution sweep point; see runs/H_phase/README.md.

**tier** Sweep · **deck** `inputs_kinshock_hs_dz2_ppc50` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I + Sec. II
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/hs_dz2_ppc50`.
...
| max_step | 880000 | `numerics.max_step` |
...
| n_cell | 1536 | domain / dz (halved when one_sided) |
...
| `inputs_kinshock_hs_dz2_ppc50` | generated deck (tracked, **never hand-edit**) |
