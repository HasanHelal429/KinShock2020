...
> Uniform periodic ambient box, dz = 0.0375 d_e,ab (dz/lambda_D = 0.758), ppc 50 (N_D = 65.9). Grid-heating resolution sweep point; see runs/H_phase/README.md.

**tier** Sweep · **deck** `inputs_kinshock_hs_dz8_ppc50` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I + Sec. II
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/hs_dz8_ppc50`.
...
| layout | symmetric | `geometry.layout` |
| slab halfwidth [d_i] | 0 | `geometry.slab_halfwidth_di` |
| domain halfwidth [d_e] | 115.2 | `geometry.domain_halfwidth_de` |
| dz [d_e] | 0.0375 | `geometry.dz_over_de` |
| boundary lo / hi | lo periodic, hi periodic | `geometry.boundary` |
| CFL | 0.75 | `numerics.cfl` |
| particle shape | 2 | `numerics.particle_shape` |
| max_step | 3520000 | `numerics.max_step` |
...
| n_cell | 6144 | domain / dz (halved when one_sided) |
...
| `inputs_kinshock_hs_dz8_ppc50` | generated deck (tracked, **never hand-edit**) |
