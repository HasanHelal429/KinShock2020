...
> Uniform periodic ambient box, dz = 0.15 d_e,ab (dz/lambda_D = 3.033), ppc 100 (N_D = 33.0). Grid-heating resolution sweep point; see runs/H_phase/README.md.

**tier** Sweep · **deck** `inputs_kinshock_hs_dz2_ppc100` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I + Sec. II
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/hs_dz2_ppc100`.
...
| `inputs_kinshock_hs_dz2_ppc100` | generated deck (tracked, **never hand-edit**) |
