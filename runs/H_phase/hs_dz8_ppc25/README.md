...
> Uniform periodic ambient box, dz = 0.0375 d_e,ab (dz/lambda_D = 0.758), ppc 25 (N_D = 33.0). Grid-heating resolution sweep point; see runs/H_phase/README.md.

**tier** Sweep · **deck** `inputs_kinshock_hs_dz8_ppc25` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I + Sec. II
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/hs_dz8_ppc25`.
...
| `inputs_kinshock_hs_dz8_ppc25` | generated deck (tracked, **never hand-edit**) |
