...
> Uniform periodic ambient box, dz = 0.3 d_e,ab (dz/lambda_D = 6.066), ppc 100 (N_D = 16.5). Grid-heating resolution sweep point; see runs/H_phase/README.md.

**tier** Sweep · **deck** `inputs_kinshock_hs_dz1_ppc100` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I + Sec. II
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/hs_dz1_ppc100`.
...
| `inputs_kinshock_hs_dz1_ppc100` | generated deck (tracked, **never hand-edit**) |
