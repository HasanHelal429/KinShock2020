...
> Uniform periodic ambient box, dz = 0.075 d_e,ab (dz/lambda_D = 1.516), ppc 100 (N_D = 65.9). Grid-heating resolution sweep point; see runs/H_phase/README.md.

**tier** Sweep · **deck** `inputs_kinshock_hs_dz4_ppc100` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I + Sec. II
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/hs_dz4_ppc100`.
...
| max_step | 1760000 | `numerics.max_step` |
...
| n_cell | 3072 | domain / dz (halved when one_sided) |
...
| `inputs_kinshock_hs_dz4_ppc100` | generated deck (tracked, **never hand-edit**) |
