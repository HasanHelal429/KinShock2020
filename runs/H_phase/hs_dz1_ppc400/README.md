...
**tier** Sweep · **deck** `inputs_kinshock_hs_dz1_ppc400` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I + Sec. II
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/hs_dz1_ppc400`.
...
| n_cell | 768 | domain / dz (halved when one_sided) |
...
| `inputs_kinshock_hs_dz1_ppc400` | generated deck (tracked, **never hand-edit**) |
