...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/R1_paper_470eV`.
...
| `inputs_kinshock_R1_paper_470eV` | generated deck (tracked, **never hand-edit**) |
