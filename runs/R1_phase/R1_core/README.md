...
> Core-tier R1: full R1 physics on a moderate domain (+-3600 d_e, 24000 cells, 125000 steps ~ 2.8 wci0^-1). Bridges R0 (smoke) and R1 (Full).

**tier** Core · **deck** `inputs_kinshock_R1_core` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/R1_core`.
...
| n_cell | 24000 | domain / dz (halved when one_sided) |
...
| `inputs_kinshock_R1_core` | generated deck (tracked, **never hand-edit**) |
