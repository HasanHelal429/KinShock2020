...
> Calibration for the ablative piston-ion warmth retune (theta_i_init = theta_e). Short, reduced-domain R1: confirm broad piston-ion phase space (Fig. 7 row 2) and M_A ~ 14 before the full R1_warm rerun.

**tier** Core · **deck** `inputs_kinshock_R1_cal` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/R1_cal`.
...
| piston init theta_i | 0.00092 | `plasma.piston.theta_i_init` |
...
| domain halfwidth [d_e] | 2700 | `geometry.domain_halfwidth_de` |
...
| max_step | 67000 | `numerics.max_step` |
...
| n_cell | 9000 | domain / dz (halved when one_sided) |
...
| `inputs_kinshock_R1_cal` | generated deck (tracked, **never hand-edit**) |
