...
> Schaeffer 2020 Table I representative quasi-1D run: strictly perpendicular (theta_Bn = 90 deg), single-species H piston + ambient, collisionless. M_A ~ 14 supercritical. Primary verification run for the WarpX heater+injector.

**tier** Full · **deck** `inputs_kinshock_R1` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/R1`.
...
| n_cell | 50000 | domain / dz (halved when one_sided) |
...
| `inputs_kinshock_R1` | generated deck (tracked, **never hand-edit**) |
