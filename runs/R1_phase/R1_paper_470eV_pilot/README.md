# Run `R1_paper_470eV_pilot`

> 50k-step pilot of R1_paper_470eV (3.41 t_ab, 0.101/wci0) to measure the numerical grid-heating rate of the ambient electrons before committing to the full ~6-day run. Physics primaries identical to the parent; only max_step and diagnostic cadences differ. Compare EP.txt col [10] against runs/R1_phase/R1_paper over the same 3.41 t_ab.

**tier** Full · **deck** `inputs_kinshock_R1_paper_470eV_pilot` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I + Sec. II
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/R1_paper_470eV_pilot`.
...
| max_step | 50000 | `numerics.max_step` |
...
| run length [1/omega_ci0] | 0.10061 | max_step * dt * omega_ci0 |
...
| `inputs_kinshock_R1_paper_470eV_pilot` | generated deck (tracked, **never hand-edit**) |
