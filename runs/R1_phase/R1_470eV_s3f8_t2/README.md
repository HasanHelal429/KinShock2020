...
**tier** Sweep · **deck** `inputs_kinshock_R1_470eV_s3f8_t2` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I + Sec. II
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/R1_470eV_s3f8_t2`.
...
| domain halfwidth [d_e] | 3824.4 | `geometry.domain_halfwidth_de` |
| dz [d_e] | 0.0375 | `geometry.dz_over_de` |
| boundary lo / hi | lo symmetry, hi open | `geometry.boundary` |
| CFL | 0.75 | `numerics.cfl` |
| particle shape | 3 | `numerics.particle_shape` |
| max_step | 7951471 | `numerics.max_step` |
...
| dz [m] | 8.13551e-09 | dz_over_de * d_e |
| dt [s] | 2.03529e-17 | CFL-limited |
| dt*omega_pe | 0.028125 | dt * omega_pe |
| n_cell | 101984 | domain / dz (halved when one_sided) |
| steps per 1/omega_ci0 | 3.97574e+06 | 1/(omega_ci0*dt) |
...
| nu_ei*dt | 4.26483e-05 | must be << 1 |
...
| `inputs_kinshock_R1_470eV_s3f8_t2` | generated deck (tracked, **never hand-edit**) |
