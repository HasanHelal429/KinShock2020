...
**tier** Full · **deck** `inputs_kinshock_R1_half` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/R1_half`.
...
| `inputs_kinshock_R1_half` | generated deck (tracked, **never hand-edit**) |
