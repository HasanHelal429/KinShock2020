...
**tier** Full · **deck** `inputs_kinshock_i0_implicit_cfl075` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I + Sec. II
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/i0_implicit_cfl075`.
...
| `inputs_kinshock_i0_implicit_cfl075` | generated deck (tracked, **never hand-edit**) |
