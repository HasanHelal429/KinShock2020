...
**tier** Full · **deck** `inputs_kinshock_i1_explicit_villasenor` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I + Sec. II
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/i1_explicit_villasenor`.
...
| max_step | 149164 | `numerics.max_step` |
...
| run length [1/omega_ci0] | 0.300149 | max_step * dt * omega_ci0 |
...
| `inputs_kinshock_i1_explicit_villasenor` | generated deck (tracked, **never hand-edit**) |
