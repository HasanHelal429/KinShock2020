...
**tier** Smoke · **deck** `inputs_kinshock_R0_half_sym` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020)
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/R0_half_sym`.
...
| `inputs_kinshock_R0_half_sym` | generated deck (tracked, **never hand-edit**) |
