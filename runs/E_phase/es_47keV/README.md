...
> eps ladder rung 5/5: T_e,ab = 47012 eV (eps = v_te,ab/c = 0.3033), B0 = 70.273 T from beta_ab = 1150. dz/lambda_D,0 = 0.379 and ppc 100 held identical to ss_dz16_ppc100, so eps is the only parameter that moves. Early-formation resolution sweep point; see runs/S_phase/README.md.

**tier** Sweep · **deck** `inputs_kinshock_es_47keV` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I + Sec. II
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/es_47keV`.
...
| dz [m] | 4.06832e-08 | dz_over_de * d_e |
| dt [s] | 1.01778e-16 | CFL-limited |
| dt*omega_pe | 0.140645 | dt * omega_pe |
| n_cell | 7167 | domain / dz (halved when one_sided) |
| steps per 1/omega_ci0 | 79493.5 | 1/(omega_ci0*dt) |
| run length [1/omega_ci0] | 0.301836 | max_step * dt * omega_ci0 |
...
| `inputs_kinshock_es_47keV` | generated deck (tracked, **never hand-edit**) |
