...
| C_s,ab / c | 0.0279285 | 0.03 | 0.931x (-6.9%) ~ |  |
| piston speed v_p / c | 0.104 | 0.104 | 1.000x (+0.0%) ok |  |
| Alfven Mach v_sh/v_A | 12.8471 | 14 | 0.918x (-8.2%) ~ |  |
| magnetosonic Mach | 11.7277 | 13 | 0.902x (-9.8%) ~ |  |
| ablation beta | 1560 | 1150 | 1.357x (+35.7%) **OFF** | same 2x convention, plus the n_amb 0.01-vs-0.008 error |
...
| gyroperiod in ablation times | 27.9285 | 33.9 | 0.824x (-17.6%) ~ | n_amb 25% high (1.118x) and theta_e recal (1.086x) |
