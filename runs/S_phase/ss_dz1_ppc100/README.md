...
**tier** Sweep · **deck** `inputs_kinshock_ss_dz1_ppc100` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I + Sec. II
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/ss_dz1_ppc100`.
...
| `inputs_kinshock_ss_dz1_ppc100` | generated deck (tracked, **never hand-edit**) |
