...
**tier** Sweep · **deck** `inputs_kinshock_ss_dz16_ppc100` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I + Sec. II
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/ss_dz16_ppc100`.
...
| dz [m] | 4.06776e-09 | dz_over_de * d_e |
| dt [s] | 1.01764e-17 | CFL-limited |
| dt*omega_pe | 0.0140625 | dt * omega_pe |
| n_cell | 71680 | domain / dz (halved when one_sided) |
| steps per 1/omega_ci0 | 7.95147e+06 | 1/(omega_ci0*dt) |
...
| nu_ei*dt | 2.13241e-05 | must be << 1 |
...
| `inputs_kinshock_ss_dz16_ppc100` | generated deck (tracked, **never hand-edit**) |
