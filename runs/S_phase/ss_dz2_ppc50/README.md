...
> R1_paper_470eV on a truncated domain and window, dz = 0.15 d_e,ab (dz/lambda_D = 3.033), ppc 50 (N_D = 16.5). Early-formation resolution sweep point; see runs/S_phase/README.md.

**tier** Sweep · **deck** `inputs_kinshock_ss_dz2_ppc50` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I + Sec. II
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/ss_dz2_ppc50`.
...
| dz [m] | 3.2542e-08 | dz_over_de * d_e |
| dt [s] | 8.14114e-17 | CFL-limited |
| dt*omega_pe | 0.1125 | dt * omega_pe |
| n_cell | 8960 | domain / dz (halved when one_sided) |
| steps per 1/omega_ci0 | 993934 | 1/(omega_ci0*dt) |
...
| nu_ei*dt | 0.000170593 | must be << 1 |
...
| `inputs_kinshock_ss_dz2_ppc50` | generated deck (tracked, **never hand-edit**) |
