...
**tier** Sweep · **deck** `inputs_kinshock_ss_dz1_ppc100_sm` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I + Sec. II
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/ss_dz1_ppc100_sm`.
...
| boundary lo / hi | lo symmetry, hi absorbing | `geometry.boundary` |
...
| `inputs_kinshock_ss_dz1_ppc100_sm` | generated deck (tracked, **never hand-edit**) |
