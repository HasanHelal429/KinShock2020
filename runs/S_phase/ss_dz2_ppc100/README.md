...
> R1_paper_470eV on a truncated domain and window, dz = 0.15 d_e,ab (dz/lambda_D = 3.033), ppc 100 (N_D = 33.0). Early-formation resolution sweep point; see runs/S_phase/README.md.

**tier** Sweep · **deck** `inputs_kinshock_ss_dz2_ppc100` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I + Sec. II
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/ss_dz2_ppc100`.
...
| `inputs_kinshock_ss_dz2_ppc100` | generated deck (tracked, **never hand-edit**) |
