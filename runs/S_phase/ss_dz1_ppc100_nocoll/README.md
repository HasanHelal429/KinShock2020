...
**tier** Sweep · **deck** `inputs_kinshock_ss_dz1_ppc100_nocoll` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I + Sec. II
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/ss_dz1_ppc100_nocoll`.
...
| `inputs_kinshock_ss_dz1_ppc100_nocoll` | generated deck (tracked, **never hand-edit**) |
