...
**tier** Sweep · **deck** `inputs_kinshock_ss_dz4_ppc400` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I + Sec. II
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/ss_dz4_ppc400`.
...
| max_step | 1193000 | `numerics.max_step` |
| ppc | piston 400, ambient 400 | `numerics.ppc` |
...
| run length [1/omega_ci0] | 0.600141 | max_step * dt * omega_ci0 |
...
| `inputs_kinshock_ss_dz4_ppc400` | generated deck (tracked, **never hand-edit**) |
