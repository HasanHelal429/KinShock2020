# Run `ss_dz1_ppc100_int1`

> R1_paper_470eV on a truncated domain and window, dz = 0.3 d_e,ab (dz/lambda_D = 6.066), ppc 100 (N_D = 16.5). Early-formation resolution sweep point; see runs/S_phase/README.md.

**tier** Sweep · **deck** `inputs_kinshock_ss_dz1_ppc100_int1` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I + Sec. II
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/ss_dz1_ppc100_int1`.
...
| heater intervals | 1 | `operators.heater.intervals` |
| injector intervals | 1 | `operators.injector.intervals` |
...
| run length [1/omega_ci0] | 0.603662 | max_step * dt * omega_ci0 |
...
| `inputs_kinshock_ss_dz1_ppc100_int1` | generated deck (tracked, **never hand-edit**) |
