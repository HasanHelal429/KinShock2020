...
**tier** Sweep · **deck** `inputs_kinshock_ss_dz4_ppc100_s3f8` · **paper** Schaeffer et al., Phys. Plasmas 27, 042901 (2020), Table I + Sec. II
...
Edit these; never the deck. Regenerate with `python scripts/make_inputs.py runs/ss_dz4_ppc100_s3f8`.
...
| `inputs_kinshock_ss_dz4_ppc100_s3f8` | generated deck (tracked, **never hand-edit**) |
